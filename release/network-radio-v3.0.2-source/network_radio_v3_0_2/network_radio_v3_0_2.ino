/*
 * Network Radio 3.0.2 standalone Arduino sketch.
...
#define NETWORK_RADIO_VERSION "3.0.2"
...
R"HTML(<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>网络收音机 3.0.2 管理</title><style>
